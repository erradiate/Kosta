...
<form method="POST" action="search">
	<input type="hidden" name="page" value="1"> <select
		...
		pattern=".{2,}" title="최소한 2자 이상의 글자가 있어야 합니다." value="${searchValue }"> <input
		type="submit" value="검색하기" class="btns">
</form>
	<c:set var="i" value="0" />
	<c:set var="j" value="3" />
	<table id="bgy">
						...
						<c:choose>
							...
							<c:when test="${e.projectStatus==3}">
								<div class="endcontainer">
									<a href="story?projectNo=${e.projectNo }"> <img
										class="imgmar endpro" src="resources/images/${e.projectMainImage }">
									</a>
